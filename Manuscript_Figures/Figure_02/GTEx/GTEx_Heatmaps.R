...
counting_values_shading = matrix(nrow=240, ncol=148)
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (all_autosomes[sample, fileColumn] == " East_Asia" || all_autosomes[sample, fileColumn] == "East_Asia") 
    {
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr1[sample, fileColumn] == " East_Asia" || chr1[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr2[sample, fileColumn] == " East_Asia" || chr2[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr3[sample, fileColumn] == " East_Asia" || chr3[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr4[sample, fileColumn] == " East_Asia" || chr4[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr5[sample, fileColumn] == " East_Asia" || chr5[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr6[sample, fileColumn] == " East_Asia" || chr6[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr7[sample, fileColumn] == " East_Asia" || chr7[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr8[sample, fileColumn] == " East_Asia" || chr8[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr9[sample, fileColumn] == " East_Asia" || chr9[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr10[sample, fileColumn] == " East_Asia" || chr10[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr11[sample, fileColumn] == " East_Asia" || chr11[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr12[sample, fileColumn] == " East_Asia" || chr12[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr13[sample, fileColumn] == " East_Asia" || chr13[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr14[sample, fileColumn] == " East_Asia" || chr14[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr15[sample, fileColumn] == " East_Asia" || chr15[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr16[sample, fileColumn] == " East_Asia" || chr16[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr17[sample, fileColumn] == " East_Asia" || chr17[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr18[sample, fileColumn] == " East_Asia" || chr18[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr19[sample, fileColumn] == " East_Asia" || chr19[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr20[sample, fileColumn] == " East_Asia" || chr20[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr21[sample, fileColumn] == " East_Asia" || chr21[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chr22[sample, fileColumn] == " East_Asia" || chr22[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
while (sample<150)
{
  ...
  while (fileColumn<6)
  {
    ...
    if (chrX[sample, fileColumn] == " East_Asia" || chrX[sample, fileColumn] == "East_Asia") 
    {
      eastAsiaCount <- eastAsiaCount + 4
    }
...
final_count_for_plotting_shading <- matrix(nrow=148, ncol=24)
sample = 1
while (sample<149)
{
  value = 1
...
pfdfilename <- paste("../PopInf_GTEx.pdf",sep="")
pdf(pfdfilename, 8,8)
