...
### READ IN DATA ###
chromosomalVariation <- read.table("../TCGA_chromosomalVariation.csv", header = FALSE, sep = ",", as.is = TRUE)
...
counting_values_chromosomalVariation = matrix(nrow=240, ncol=56)
...
final_count_for_plotting_chromosomalVariation <- matrix(nrow=56, ncol=24)
sample = 1
while (sample<61)
{
  value = 1
