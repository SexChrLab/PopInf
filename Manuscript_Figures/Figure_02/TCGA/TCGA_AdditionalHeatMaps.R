...
chromosomalVariation <- matrix(nrow=404, ncol=25)
chromosomalVariation[1,1]="Sample"
chromosomalVariation[1,2]="All Autosomes"
chromosomalVariation[1,3]="Chr 1"
chromosomalVariation[1,4]="Chr 2"
chromosomalVariation[1,5]="Chr 3"
chromosomalVariation[1,6]="Chr 4"
chromosomalVariation[1,7]="Chr 5"
chromosomalVariation[1,8]="Chr 6"
chromosomalVariation[1,9]="Chr 7"
chromosomalVariation[1,10]="Chr 8"
chromosomalVariation[1,11]="Chr 9"
chromosomalVariation[1,12]="Chr 10"
chromosomalVariation[1,13]="Chr 11"
chromosomalVariation[1,14]="Chr 12"
chromosomalVariation[1,15]="Chr 13"
chromosomalVariation[1,16]="Chr 14"
chromosomalVariation[1,17]="Chr 15"
chromosomalVariation[1,18]="Chr 16"
chromosomalVariation[1,19]="Chr 17"
chromosomalVariation[1,20]="Chr 18"
chromosomalVariation[1,21]="Chr 19"
chromosomalVariation[1,22]="Chr 20"
chromosomalVariation[1,23]="Chr 21"
chromosomalVariation[1,24]="Chr 22"
chromosomalVariation[1,25]="Chr X"

row=2
while (row<405)
{
  if(samples_populations[row,2]!=samples_populations[row,3] ||
     samples_populations[row,2]!=samples_populations[row,4] ||
     samples_populations[row,2]!=samples_populations[row,5] ||
     samples_populations[row,2]!=samples_populations[row,6] ||
     samples_populations[row,2]!=samples_populations[row,7] ||
     samples_populations[row,2]!=samples_populations[row,8] ||
     samples_populations[row,2]!=samples_populations[row,9] ||
     samples_populations[row,2]!=samples_populations[row,10] ||
     samples_populations[row,2]!=samples_populations[row,11] ||
     samples_populations[row,2]!=samples_populations[row,12] ||
     samples_populations[row,2]!=samples_populations[row,13] ||
     samples_populations[row,2]!=samples_populations[row,14] ||
     samples_populations[row,2]!=samples_populations[row,15] ||
     samples_populations[row,2]!=samples_populations[row,16] ||
     samples_populations[row,2]!=samples_populations[row,17] ||
     samples_populations[row,2]!=samples_populations[row,18] ||
     samples_populations[row,2]!=samples_populations[row,19] ||
     samples_populations[row,2]!=samples_populations[row,20] ||
     samples_populations[row,2]!=samples_populations[row,21] ||
     samples_populations[row,2]!=samples_populations[row,22] ||
     samples_populations[row,2]!=samples_populations[row,23] ||
     samples_populations[row,2]!=samples_populations[row,24] ||
     samples_populations[row,2]!=samples_populations[row,25])
  {
    chromosomalVariation[row,]=samples_populations[row,]
  }
  row=row+1
}
chromosomalVariation2 <- na.omit(chromosomalVariation)

# PICK OUT ONLY SAMPLES WITH VARIATION ACROSS THE CHROMOSOME
include_list <- data.matrix(chromosomalVariation2[,1])
...
counting_values_chromosomalVariation = matrix(nrow=240, ncol=(nrow(chromosomalVariation2))-1)

# ALL AUTOSOMES
sample <- 2
while (sample<(nrow(chromosomalVariation2)+1))
{
  countingValuesRow <- 1
...
final_count_for_plotting_chromosomalVariation <- matrix(nrow=(nrow(chromosomalVariation2)-1), ncol=24)
sample = 1
while (sample<(nrow(chromosomalVariation2)))
{
  value = 1
...
pfdfilename <- paste("../PopInf_TCGA_chromosomalVariation.pdf",sep="")
pdf(pfdfilename, 8,8)
