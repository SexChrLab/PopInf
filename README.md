...
### Edit snakemake_PopInf_slurm.sh
...
#### 6. List of chromosomes you wish to analyze together (Line 37)
```
...
Alternatively, if you run PopInf independently on all autosomes and then wish to only merge a sub-set of the chromosomes for PCA visualization and to generate the inferred ancestry report, please specify those chromosome numbers in line 37 of `snakemake_PopInf_slurm.sh` only.
